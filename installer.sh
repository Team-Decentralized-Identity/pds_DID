...
PDS_HOSTNAME="${2:-}"
PDS_ADMIN_EMAIL="${3:-}"
PDS_DID_PLC_URL="https://plc.didconnect.tech"
PDS_BSKY_APP_VIEW_URL="https://didconnect.tech"
PDS_BSKY_APP_VIEW_DID="did:web:didconnect.tech"
PDS_REPORT_SERVICE_URL="https://mod.didconnect.tech"
